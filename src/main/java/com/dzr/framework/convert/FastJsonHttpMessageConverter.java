package com.dzr.framework.convert;

import com.alibaba.fastjson.serializer.SerializeConfig;

import com.dzr.common.util.ClassPathScanHandler;
import com.dzr.framework.fastjson.serializer.EnumSerializer;
...
/**
 * Package Name: com.sdxd.framework.convert
 * Description:
 * Author: qiuyangjun
...
public class FastJsonHttpMessageConverter extends com.alibaba.fastjson.support.spring.FastJsonHttpMessageConverter {
    ...
    protected void writeInternal(Object obj, HttpOutputMessage outputMessage) throws IOException,
        ...
        Set<Class<?>> calssList = handler.getPackageAllClasses("com.sdxd", true);
